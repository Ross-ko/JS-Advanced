...
function solve() {
  ...
  function reservationCreator(firstName, lastName, dateIn, dateOut, peopleCount) {
    ...
    btnOne.addEventListener('click', () => backToTheRoots(firstName, lastName, dateIn, dateOut, peopleCount));
    btnTwo.addEventListener('click', () => confirmReservation(firstName, lastName, dateIn, dateOut, peopleCount));
  }
  ...
  function confirmReservation(firstName, lastName, dateIn, dateOut, peopleCount) {
    reservationInfoEl.textContent = '';
